...
- 工作指引 skills：`parse-notes`、`apply-template`、`validate-spec`

## 工作流程

依以下 6 個 phase 執行。每進入下一 phase 前，確認上一 phase 產出齊全。
...
```
已產出：specs/{feature-name}/spec.md
完整填寫：7/10 章節
待補充：3 章節
...
建議補充這些資訊後重新執行 /boss，或直接編輯 spec.md。
```
